...
BEGIN
    ...
    -- barcode being uploaded. We never expect the cleaned barcode to be longer than 93 characters.
    IF char_length(v_clean_barcode) > 100 THEN
    ...
    -- Pad the barcode to 100 digits long and make it upper case for consistency.
    v_clean_barcode := LPAD(UPPER(v_clean_barcode), 100, '0');
